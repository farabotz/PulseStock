CREATE TYPE "public"."user_role" AS ENUM('admin', 'warehouse_manager', 'staff');--> statement-breakpoint
CREATE TYPE "public"."transfer_type" AS ENUM('transfer', 'adjustment', 'initial');--> statement-breakpoint
...
CREATE TABLE "products" (
	...
	"critical_stock_threshold" integer DEFAULT 10 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "stock_transfers" (
	...
	"transfer_type" "transfer_type" DEFAULT 'transfer' NOT NULL,
	"notes" text,
...
CREATE UNIQUE INDEX "product_warehouse_idx" ON "inventory_levels" USING btree ("product_id","warehouse_id");